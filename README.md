...
## Some of the objective to find are as follow:
* EDA of Life expectancy, Adult Mortality, infant deaths, BMI
* Influential Factors affecting Life Expectancy.
* Predictive Models To Forecast Life Expectancy.
* Future Life Expectancies.
* Trend Detection.
* Factor affecting life expectancy in india.
* A feature affecting life expectancy in india.
